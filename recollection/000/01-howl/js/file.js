...
var MESSAGES = {
  who: "http://jcgaal.com/",
  why: "relentless cascade of turmoils in need of outlets",
  help: "available commands: who, why, framework, truist",
  framework: "It begins with identity and ends in solitary dissolution. The quest is to find oneself, and unleash what is within. No rush, but time the clock is ticking.\n Language, music, transgressions, art, defiance, konwitallness, humbleness, and learning are good foundations that shape a particular type of phony.\n Lack of substance and the constant pursuit of the illusory noumena, or at least the pretence of doing so.\n And finally, just exhaustion, complete and total disdain for the cacophony, just yearning for quiteness and nature. It will come, I know it will.",
  truist: "I did see the best minds of my generation destroyed by madness, starving hysterical naked,... well, except the starving part. The rest is true with a cellphone and an 0F."
...
$(function() {
  ...
  function(err, results) {
    term.set_command('');
    term.echo('type away, the rest will become obvious');
  });
